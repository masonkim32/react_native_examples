...
// This version pulls a secified photo from the camera roll
// import PhotoBackdrop from "./PhotoBackdrop";


const STORAGE_KEY = "@SmarterWeather:zip";

class SmarterWeatherProject extends Component {
  constructor(props) {
    super(props);
    this.state = {
      forecast: null
  ...
  _getForecastForZip = zip => {
    ...
    AsyncStorage.setItem(STORAGE_KEY, zip)
      ...
      .catch(error => console.error("AyncStorage error: " + error.message))
      .done();
...
export default SmarterWeatherProject;